	...
	<body>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="table-responsive">
						...
						<center><h1><span class="badge badge-pill badge-default">Handschumacher Dining Hall Review</span></h1></center>
						<br><br>
						<table class="table">
							<thead>
	    ...
	    <div class="container-fluid">
	      ...
	      <div id="submitReview" class="row">
	        <div class="col-md-12">
	          <form action="https://dragoneats.000webhostapp.com/lab5/addHans.php" method="post">
	            <center><h1>Submit a Review for Handschumacher</h1></center>
